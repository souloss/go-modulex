...
func newAuthor(db *gorm.DB, opts ...gen.DOOption) author {
	...
	_author.authorDo.UseModel(&entities.Author{})

	tableName := _author.authorDo.TableName()
	_author.ALL = field.NewAsterisk(tableName)
	_author.ID = field.NewString(tableName, "id")
...
type IAuthorDo interface {
	...
	Unscoped() IAuthorDo
	Create(values ...*entities.Author) error
	CreateInBatches(values []*entities.Author, batchSize int) error
	Save(values ...*entities.Author) error
	First() (*entities.Author, error)
	Take() (*entities.Author, error)
	Last() (*entities.Author, error)
	Find() ([]*entities.Author, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entities.Author, err error)
	FindInBatches(result *[]*entities.Author, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*entities.Author) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*entities.Author, error)
	FirstOrCreate() (*entities.Author, error)
	FindByPage(offset int, limit int) (result []*entities.Author, count int64, err error)
...
func (a authorDo) Create(values ...*entities.Author) error {
	if len(values) == 0 {
		return nil
	}
...
func (a authorDo) CreateInBatches(values []*entities.Author, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a authorDo) Save(values ...*entities.Author) error {
	if len(values) == 0 {
		return nil
	}
...
func (a authorDo) First() (*entities.Author, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*entities.Author), nil
	}
}

func (a authorDo) Take() (*entities.Author, error) {
...
func (a authorDo) Last() (*entities.Author, error) {
...
func (a authorDo) Find() ([]*entities.Author, error) {
	result, err := a.DO.Find()
	return result.([]*entities.Author), err
}

func (a authorDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*entities.Author, err error) {
	buf := make([]*entities.Author, 0, batchSize)
...
func (a authorDo) FindInBatches(result *[]*entities.Author, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a authorDo) FirstOrInit() (*entities.Author, error) {
...
func (a authorDo) FirstOrCreate() (*entities.Author, error) {
...
func (a authorDo) FindByPage(offset int, limit int) (result []*entities.Author, count int64, err error) {
...
func (a authorDo) Delete(models ...*entities.Author) (result gen.ResultInfo, err error) {
